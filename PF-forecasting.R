...
(rmse1 <- var(y1[2:n1] - 100 * mpred.ssm1[, 2]) / var(y1[2:n1] - 100 * mpred.pf1[, 2]))
(rmse2 <- var(y2[2:n2] - 100 * mpred.ssm2[, 2]) / var(y2[2:n2] - 100 * mpred.pf2[, 2]))
...
plot(y2[2:n2], ylim = c(0, 20), pch = 15, yaxs = "i", xaxs = "i", xaxt = "n",
     xlab = "", ylab = "", axes = T)
